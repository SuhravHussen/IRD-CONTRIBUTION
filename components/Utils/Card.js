...
function Card({ link, title, subTitle, totalDua, onClick, midCard, language = "en" }) {
  return (
    <Link href={link}>
      <div onClick={onClick}>
            ...
            <div className="text-left">
              ...
              {subTitle && (
                <p className="text-mute-grey text-xs ">
                  {language === "en" ? "Subcategory" : "সাব ক্যাটেগোরি"} : {subTitle}
                </p>
              )}
            </div>
          </div>
          {totalDua && (
            <div className="mr-5 flex flex-row items-center">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="text-mute-grey text-xs ">{language === "en" ? "Duas" : "দোয়া"}</p>
              </div>
            </div>
          )}
        </div>
