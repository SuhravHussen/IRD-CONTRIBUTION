  ...
  return (
    <>
      <Link href={`/bookmark/list/${bookmark?.id}`}>
        <div className="bg-red-100 w-full h-[6.625rem]  p-3 border-[.5px] border-solid border-devider px-5 dark:bg-[#223449] dark:border-none animate-fade-in-up cursor-pointer">
